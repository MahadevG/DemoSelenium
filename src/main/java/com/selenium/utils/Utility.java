...
import com.selenium.constant.Constants;
...
public class Utility {
	...
	public static WebDriver LaunchBrowser(String browsername) {
		...
		if (browsername.equals(Constants.CHROME)) {
			...
			System.setProperty("webdriver.chrome.driver", Constants.BASE_DRIVER_PATH + "chromedriver");
			driver = new ChromeDriver(getChromeOptions());
		} else if (browsername.equals(Constants.FIRE_FOX)) {
			// latest gecko driver path

			System.setProperty("webdriver.gecko.driver", Constants.BASE_DRIVER_PATH + "geckodriver64");
			driver = new FirefoxDriver(getFireFoxOptions());
		} else if (browsername.equals(Constants.INTERNET_EXPLORER)) {

			System.setProperty("webdriver.ie.driver", Constants.BASE_DRIVER_PATH + "IEDriverServer");
	...
	public static void alertPopup(String expectedtxt) {
	  ...
	  "popup_content_alert"))); String actualTxt =
	  driver.findElement(By.id("popup_content_alert")).getText();
	...
	**/
	...
	public static void confirmPopup(String status, String expectedtxt) throws InterruptedException {
		 ...
		 wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
		 "popup_content_confirm"))); String actualTxt =
		 driver.findElement(By.id("popup_content_confirm")).getText();
		 Assert.assertEquals(actualTxt, expectedtxt); if (status == "OK") {
		 Thread.sleep(1000); driver.findElement(By.id("popup_ok_confirm")).click(); }
	...
	**/
	...
	public static DesiredCapabilities getChromeOptions() {
		...
		chromePrefs.put("download.default_directory",
				System.getProperty("user.dir") + "\\" + Constants.DEFULT_DOWNLOAD_PATH_CHROME);
